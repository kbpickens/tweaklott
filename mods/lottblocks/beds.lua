...
for i in ipairs(lottblocks_list) do
    ...
    beds.register_bed("lottblocks:bed_"..colour, 
        {
                description = beddesc,
                inventory_image = "lottblocks_bed_side_"..colour..".png",
                wield_image = "lottblocks_bed_side_"..colour..".png",
                tiles = {
                        bottom = {"lottblocks_bed_top_bottom_"..colour..".png", "default_wood.png",  "lottblocks_bed_side_"..colour..".png",  "lottblocks_bed_side_"..colour..".png",  "lottblocks_bed_side_"..colour..".png",  "lottblocks_bed_side_"..colour..".png"}, -- the tiles of the bottom part of the bed.
                        top = {"lottblocks_bed_top_top_"..colour..".png", "default_wood.png",  "lottblocks_bed_side_top_r_"..colour..".png",  "lottblocks_bed_side_top_l_"..colour..".png",  "lottblocks_bed_top_front.png",  "lottblocks_bed_side_"..colour..".png"} -- the tiles of the bottom part of the bed.
                },
                nodebox = {
		bottom = {-0.5, -0.5, -0.5, 0.5, 0.25, 0.5},
		top = {-0.5, -0.5, -0.5, 0.5, 0.25, 0.5},
                },
                selectionbox = {-0.5, -0.5, -0.5, 0.5, 0.25, 1.5},  -- for both nodeboxes (see [Node boxes])
                recipe = {                                         -- Craft recipe
